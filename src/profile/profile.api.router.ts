...
router.get('/v1/profile/events',        api.auth(eventsApi.list({ loggedUser: true }).bind(eventsApi)({ loggedUser: true }), 'user', 'view', [ Scope.ALL ]));
...
router.get('/v1/user/events',        api.auth(eventsApi.list({ loggedUser: true }).bind(eventsApi)({ loggedUser: true }), 'user', 'view', [ Scope.ALL ]));
