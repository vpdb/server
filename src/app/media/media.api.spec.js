		...
		it('should fail when providing a ws playfield for a fs file', function(done) {
			...
			hlp.file.createPlayfield(user, request, 'ws', function(playfield) {
				request
					...
					hlp.expectValidationError(err, res, 'versions.0.files.0._playfield_images.0', 'orientation is set to fs');
					done();
				});
			});
		});
		...
		it('should fail when providing a fs playfield for a ws file', function(done) {
			...
			hlp.file.createPlayfield(user, request, 'fs', function(playfield) {
				request
					...
					.end(function (err, res) {
						hlp.expectValidationError(err, res, 'versions.0.files.0._playfield_images.0', 'orientation is set to ws');
						done();
					});
			});
		});
		...
		it('should fail when image orientation for playfield-fs is ws', function(done) {
			...
			hlp.file.createPlayfield(user, request, 'ws', 'playfield-fs', function(playfield) {
				request
					...
					.end(function (err, res) {
						hlp.expectValidationError(err, res, 'versions.0.files.0._playfield_images.0', 'should be portrait');
						done();
					});
			});
		});
		...
		it('should fail when image orientation for playfield-ws is fs', function(done) {
			...
			hlp.file.createPlayfield(user, request, 'fs', 'playfield-ws', function(playfield) {
				request
					...
					.end(function (err, res) {
						hlp.expectValidationError(err, res, 'versions.0.files.0._playfield_images.0', 'should be landscape');
						done();
					});
			});
		});
