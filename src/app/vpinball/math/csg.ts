...
export default class CSG {
	...
	static iEval(tokens: any, index = 0) {
		if (typeof tokens === 'string') {
			...
			if (!CSG.sourceMesh)
				...
				CSG.currentPrim = (CSG.currentPrim as any)[op](CSG.nextPrim);
			}
			if (CSG.doRemove) {
	...
	static eval(tokens: any, doRemove: boolean) {//[['add',mesh,mesh,mesh,mesh],['sub',mesh,mesh,mesh,mesh]]
		CSG.currentOp = null;
		CSG.sourceMesh = null;
