...
export interface BackglassVersionModel extends PrettyIdModel<BackglassVersion> {}
...
backglassVersionSchema.plugin(prettyIdPlugin, { model: 'BackglassVersion' } as PrettyIdOptions);
