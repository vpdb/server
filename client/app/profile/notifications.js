...
angular.module('vpdb.profile.notifications', [])

	.controller('ProfileNotificationsCtrl', function($scope, $rootScope, AuthService, ApiHelper, ProfileResource) {
		...
		$scope.updateUserPreferences = function() {
			ProfileResource.patch({ preferences: $scope.updatedPreferences }, function(user) {
				...
				$rootScope.showNotification('Notification Preferences successfully saved');
