...
export const gameListCacheCounters: Array<CacheCounterConfig<Game[]>> = [{
	modelName: 'game',
...
export const gameDetailsCacheCounters: Array<CacheCounterConfig<Game>> = [{
	modelName: 'game',
	counters: ['releases', 'views', 'downloads', 'comments', 'stars'],
	get: (game: Game, counter: GameCounterType) => ({ [game.id]: game.counter[counter] }),
